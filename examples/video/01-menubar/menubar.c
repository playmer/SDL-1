...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char** argv) {
  //SDL::IOStream sar_file = SDL::IOStream(SDL_IOFromFile("C:/Users/playmer/Downloads/Tsukihime/Tsukihime_jp/arc.sar", "r"));
  //Archive::Sar sar_archive((const uint8_t*)"C:/Users/playmer/Downloads/Tsukihime/Tsukihime_og/ARC.SAR", 0);

  //auto script = ScriptParsing::Script::SelectScript();

  //CommandLine::Options::ParseOptions(argc, argv);
